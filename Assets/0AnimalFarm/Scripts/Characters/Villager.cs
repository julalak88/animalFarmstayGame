...
public class Villager : Character
{
    ...
    {
        _reached = true;
        if (target.type == PointTarget.PointTargetType.VILLAGER_STAND || target.type == PointTarget.PointTargetType.STAFF_WATERING || target.type == PointTarget.PointTargetType.STAFF_REST)
