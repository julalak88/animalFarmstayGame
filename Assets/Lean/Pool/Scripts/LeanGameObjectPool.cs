...
namespace Lean.Pool
{
	...
	public class LeanGameObjectPool : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		public GameObject Spawn(Vector3 position, Transform parent = null, bool worldPositionStays = true) {
			var clone = default(GameObject);

			TrySpawn(position, Quaternion.identity, parent, worldPositionStays, ref clone);
